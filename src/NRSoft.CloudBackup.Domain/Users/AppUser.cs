...
namespace NRSoft.CloudBackup.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CloudBackupDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CloudBackupEfCoreEntityExtensionMappings to extend the IdentityUser entity
